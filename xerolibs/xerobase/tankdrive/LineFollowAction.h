...
namespace xero {
    namespace base {
        ...
        class LineFollowAction : public TankDriveAction {
        public:
            ...
            LineFollowAction(LightSensorSubsystem &ls_subsystem, TankDrive &db_subsystem, double power, double distance, double power_adjust) ;
            ...
            LineFollowAction(LightSensorSubsystem &ls_subsystem, TankDrive &db_subsystem, const std::string &power_name, const std::string &distance_name, const std::string &power_adjust_name) ;
