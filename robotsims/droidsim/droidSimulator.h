    ...
    namespace sim
    {
        ...
        namespace droid
        {
            ...
            private:
                ...
                std::shared_ptr<xero::sim::droid::OIModel> oi_ ;     
                bool visualizer_ ;
            };
        } // namespace droid
    } // namespace sim
