...
namespace xero
{
    namespace sim
    {
        ...
        namespace motorcontroller
        {
            ...
            class MotorControllerSimulator : public xero::sim::RobotSimBase
            {
            public:
                /// \brief Create a simulator for Phoenix.
                /// \param paramfile the filename of the robot's parameter file
                MotorControllerSimulator(const std::string &paramfile);

                /// \brief Destroy the simulator.
                virtual ~MotorControllerSimulator();
            ...
            private:
                ...
                std::shared_ptr<xero::sim::motorcontroller::OIModel> oi_ ;     
                bool visualizer_ ;
            };
        } // namespace motorcontroller
    } // namespace sim
