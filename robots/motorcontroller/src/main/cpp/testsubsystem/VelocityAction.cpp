...
namespace xero {
    namespace motorcontroller {
        ...
        VelocityAction::VelocityAction(TestSubsystem &sub): xero::base::MotorEncoderVelocityAction(sub, 0), sub_(sub) 
        {
            ...
            entry_ = frc::Shuffleboard::GetTab("SmartDashboard").Add("Velocity", static_cast<double>(0.0)).WithWidget(frc::BuiltInWidgets::kNumberSlider).WithProperties(propmap).GetEntry();
        }
